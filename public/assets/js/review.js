 document.addEventListener("DOMContentLoaded", function () {
        ...
        function checkLoginStatus() {
          // This would check if user is logged in from your authentication system
          // For demo, we'll set it to false initially
          isLoggedIn = false;
          customerId = null;

          // If you have authentication, you might do something like:
        ...
        function loadReviews() {
          ...
          reviewsContainer.innerHTML =
            '<div class="review-item">Loading reviews...</div>';
          ...
          fetch("../backend/getPlatformReviews.php")
            ...
            .catch((error) => {
              reviewsContainer.innerHTML =
                '<div class="review-item">Error loading reviews</div>';
