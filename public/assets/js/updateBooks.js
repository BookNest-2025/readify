document.addEventListener("DOMContentLoaded", function () {
        ...
        function searchBooks() {
          ...
          searchResults.innerHTML =
            '<div class="book-result">Searching...</div>';
        ...
        function displaySearchResults(books) {
          if (books.length === 0) {
            searchResults.innerHTML =
              '<div class="book-result">No books found</div>';
            return;
          }
          ...
          books.forEach((book) => {
            html += `
                        <div class="book-result" data-id="${book.book_id}">
                            <strong>${
                              book.title
                            }</strong> by ${book.authors.join(", ")}<br>
        ...
        function populateForm(book) {
          ...
          document.getElementById("sold").value = book.sold;
